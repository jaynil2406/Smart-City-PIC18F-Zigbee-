...
const unsigned char SMSread[10]={'A','T','+','C','M','G','R','=',' ',0X0D};

unsigned char SMS_format[10]={'A','T','+','C','M','G','F','=','1',0x0D};
unsigned char SMS_format1[10]={'A','T','+','C','M','G','F','=','0',0x0D};
...
const unsigned char Message6[37]="   --->LED Display Board Data<----   ";
    ...
    while(1){
		...
		if(F_WaitForReceive==1){
         ...
         if((CRC==Rv_CRC) && (DATA_RX[0]=='@')){
             ...
             if(LED_PATTERN[0]==0x01){
                 Array[3]='1';
                
             }
             else if(LED_PATTERN[0]==0x02){
                 Array[3]='2';
             }
             else if(LED_PATTERN[0]==0x04){
                 Array[3]='4';
             }
             else if(LED_PATTERN[0]==0x08){
                 Array[3]='8';
             }
             else{
                 Array[3]='0'; 
