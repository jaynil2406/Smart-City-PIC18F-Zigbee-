...
#define MOTION_TRIS               TRISFbits.TRISF3
#define MOTION_LAT                LATFbits.LATF3
#define MOTION_PORT               PORTFbits.RF3
#define MOTION_ANS                ANCON1bits.ANSEL8
#define MOTION_SetHigh()            do { LATFbits.LATF3 = 1; } while(0)
#define MOTION_SetLow()             do { LATFbits.LATF3 = 0; } while(0)
#define MOTION_Toggle()             do { LATFbits.LATF3 = ~LATFbits.LATF3; } while(0)
#define MOTION_GetValue()           PORTFbits.RF3
#define MOTION_SetDigitalInput()    do { TRISFbits.TRISF3 = 1; } while(0)
#define MOTION_SetDigitalOutput()   do { TRISFbits.TRISF3 = 0; } while(0)
#define MOTION_SetAnalogMode()  do { ANCON1bits.ANSEL8 = 1; } while(0)
#define MOTION_SetDigitalMode() do { ANCON1bits.ANSEL8 = 0; } while(0)
